package co.com.ceiba.aplication.commands

import co.com.ceiba.aplication.events.{ExitoUsuarioEvent, FalloEvent, UsuarioEliminadoEvent}
import co.com.ceiba.domain.services.EliminarUsuarioUseCase
